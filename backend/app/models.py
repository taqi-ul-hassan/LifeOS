...
class Memory(Timestamped):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=uid)
    user_id: Mapped[str] = mapped_column(ForeignKey("users.id"), index=True)
    title: Mapped[str] = mapped_column(String(300), default="Untitled memory")
    layer: Mapped[str] = mapped_column(String(30))
    memory_type: Mapped[str] = mapped_column(String(30), default="semantic")
    content: Mapped[str] = mapped_column(Text)
    ...
    embedding_ref: Mapped[str | None] = mapped_column(String(100))
...
class AIObservation(Timestamped):
    ...
    acted_on_at: Mapped[datetime | None] = mapped_column(DateTime)
...
class KnowledgeGraphEdge(Timestamped):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=uid)
    user_id: Mapped[str] = mapped_column(ForeignKey("users.id"), index=True)
    source_id: Mapped[str] = mapped_column(ForeignKey("knowledge_graph_nodes.id"))
    target_id: Mapped[str] = mapped_column(ForeignKey("knowledge_graph_nodes.id"))
